...
public class ChatFaceView extends RelativeLayout {
	...
	private void init(Context context) {
		...
		LayoutInflater.from(mContext).inflate(R.layout.im_chat_face_view, this);
	...
	// int[][] resId = ExpressionParser.Smilies.getIds();
	// String[][] strArray = ExpressionParser.Smilies.getTexts();
	...
	// LinearLayout.LayoutParams(dip_To_px(mContext, 5),
	...
	// View contentView =
	// LayoutInflater.from(mContext).inflate(R.layout.im_emotion_gridview,
	// null);
	...
	// int[][] resId = ExpressionParser.Gifs.getIds();
	// String[][] strArray = ExpressionParser.Gifs.getTexts();
	//
	...
	// }
	// LinearLayout.LayoutParams params = new
	// LinearLayout.LayoutParams(dip_To_px(mContext, 5), dip_To_px(mContext,
	// 5));
	// params.setMargins(0, 0, dip_To_px(mContext, 5), 2);
	// point.setLayoutParams(params);
	// mPointsLayout.addView(point);
	...
	// for (int i = 0; i < resId.length; i++) {
	// View contentView =
	// LayoutInflater.from(mContext).inflate(R.layout.chat_face_gridview, null);
	// GridView gridView = (GridView) contentView.findViewById(R.id.gridView);
	// gridView.setSelector(R.drawable.chat_face_bg);
	...
	public void switchViewPager3() {
		...
		for (int i = 0; i < pageCount; i++) {
			View contentView = LayoutInflater.from(mContext).inflate(R.layout.im_emotion_gridview, null);
	...
	class EmotionImgAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (null == convertView) {
				...
				convertView = inflater.inflate(R.layout.im_item_emotion, parent, false);
