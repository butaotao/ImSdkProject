...
public class HtmlUtils {
	...
	public static CharSequence transform50SpanString(String msg, boolean canClick) {
		CharSequence sequence = transformSpanString(msg, canClick);
	...
	public static CharSequence addSmileysToMessage(String msg, boolean canClick) {
		ExpressionParser parser = ExpressionParser.getInstance(ImSdk.getInstance().context);
