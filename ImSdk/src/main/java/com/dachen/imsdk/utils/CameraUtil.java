...
public final class CameraUtil {
	...
	public static void captureImage(Fragment frgm, Uri outputUri, int requestCode) {
		final Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
		intent.putExtra(MediaStore.EXTRA_OUTPUT, outputUri);
	...
	/**
	 * 调用系统裁减功能，裁减某张指定的图片，并输出到指定的位置，不传outputX和outputY，截取到多大就输出多大
	 * 
	 * @param activity
	 * @param originalFileUri
	 *            原始图片位置
	...
	public static void cropImage(Fragment frgm, Uri originalFileUri, Uri outputFileUri, int requestCode, int aspectX,
